            ...
            wasm_bindgen_futures::future_to_promise(async move {
                ...
                let wrapper_code = format!(
                    ...
                    (async function() {{
                        ...
                        try {{
                            // Execute the user code with proper async handling
                            let result;
...
// Re-export the WASM types when the feature is enabled
#[cfg(feature = "wasm")]
pub use wasm_runtime::*;

// When WASM feature is not enabled, provide empty implementations
