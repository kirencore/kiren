...
pub fn setup_environment(scope: &mut v8::HandleScope, context: v8::Local<v8::Context>) -> Result<()> {
    ...
    let node_env_value = v8::String::new(scope, 
    ...
    let port_value = v8::String::new(scope, 
